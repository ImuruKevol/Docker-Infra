...
"""
        ...
        return {
            ...
            "base_content": {
                ...
                "rules": [
                    ...
                    "only Docker Infra managed networks when networks are declared: docker_infra_overlay for Swarm targets, docker_infra_bridge for non-Swarm Compose targets",
    ...
    def _runtime_repair_system_prompt(self):
        return "\n".join(
            [
                ...
                "Do not run docker compose down --volumes, docker volume rm/prune, docker system prune --volumes, or equivalent persistent volume deletion during repair, migration, release, rollback, or redeploy work. Do not invent secret values; use generated_secret_keys.",
    ...
    def _system_prompt(self, target):
        common = [
            ...
            "Persistent Docker volumes are protected: do not run docker compose down --volumes, docker volume rm/prune, or docker system prune --volumes unless Docker Infra explicitly provides a volume destruction permission for a delete flow.",

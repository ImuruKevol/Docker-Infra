...
class NodeReporterStaticContractTest(unittest.TestCase):
    def test_reporter_routes_and_servers_page_contract_are_declared(self):
        ...
        self.assertIn("data-node-resource-chart-canvas", dashboard_template)
        ...
        self.assertIn("document.querySelectorAll('[data-node-resource-chart-canvas]')", dashboard_view_ts)
        ...
        self.assertIn("OnCalendar=*:0/10", commands)

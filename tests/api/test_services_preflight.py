...
class ServicesPreflightStaticContractTest(unittest.TestCase):
    ...
    def test_service_create_supports_templates_and_draft_sources(self):
        ...
        self.assertIn("this.creationMode() === 'template'", view)
        self.assertIn("await this.applyTemplateDraft()", view)
        self.assertIn("await this.generateServiceWithAi()", view)
        self.assertIn("await this.applyManualCompose()", view)
        ...
        self.assertIn("{{nextStepLabel()}}", template)
        self.assertIn("nextStepBusy()", template)
        self.assertIn("nextStepIconClass()", template)
